...
#import "KITDeviceModel.h"

NS_ASSUME_NONNULL_BEGIN

NS_SWIFT_NAME(Device)
KIT_FINAL_CLASS
@interface KITDevice : NSObject

@property (nonatomic, readonly, class) KITDevice *current;

@property (nonatomic, readonly) KITDeviceModel model;
