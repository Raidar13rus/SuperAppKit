...
typedef NS_ENUM(NSInteger, KITTimerState) {
    KITTimerStateStopped,
    KITTimerStateSuspended,
    KITTimerStateSuspendedBackground,
    KITTimerStateStarted
};

@interface KITTimer : NSObject

@property (nonatomic, assign, readonly) KITTimerState state;
@property (nonatomic, assign) NSTimeInterval timeoutDate;
